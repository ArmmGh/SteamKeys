...
const Footer = () => {
  const [questions, setQuestions] = useState([
    ...
    {
      id: 5,
      text: 'Как получить вклад?',
      answer: 'Все вклады находятся в профиле на сайте. После того, как 24 час прошёл, зайдите в свой профиль и выберите дальнейшее действие,получить вырученные средства на свой баланс.',
      collapsed: false,
    },
    {
      id: 6,
      text: 'Я вкладил, куда мне придет деньги??',
      answer: 'Откройте профиль и делайте вклад и через 24 час получитье + 20% от вашего вклада',
      collapsed: false,
    },
  ]);
