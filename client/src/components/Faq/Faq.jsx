  ...
  const [questions, setQuestions] = useState([
    {
      ...
      answer:
        'Авторизуйтесь удобным для Вас способом (Steam, VK, Facebook).Пополняйте баланс и выбирайте понравившиеся Вам игры.',
      collapsed: false,
    },
    {
      id: 1,
    ...
    },
    {
      ...
      answer:
        'Обычно средства приходят моментально, но в некоторых случаях требуется подождать 5-10 минут и средства будут начислены. Если средства не пришли по истечению этого времени, напишите в тех. поддержку, Вам обязательно помогут.',
      collapsed: false,
    },
    {
      id: 3,
    ...
    {
      id: 5,
      text: 'Что значит игра до 399 Р?',
      answer:
        'Это значит, что Вам выпала одна из более, чем 900 игр Steam стоимостью от 29 до 399 Р. Получить свой ключ от игры можно в профиле. Продать ее можно за 9 Р до получения, вне зависимости от реальной стоимости игры в игровом магазине Steam.',
      collapsed: false,
    },
    {
      id: 6,
