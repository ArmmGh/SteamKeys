        ...
        <div className="guarant">
          <div className="item">
            ...
            <div className="text">
              ...
              стиме всего за копейки. Самое главное, это возможность получить
              Дорогую игру, при этом оплатив всего 69 руб. В LIVE-ленте
              отображаются полученные игры, реальными клиентами!
            </div>
          </div>
          <div className="item">
            <div className="pic">
